#This is a Mars Rover Navigator project 
...
-These instructions will get you a copy of an [online demo](http://qiao.github.com/PathFinding.js/visual) to show how the algorithms execute.
...
npm manager
`node.js` , then use `npm` to install the dependencies: 
    npm install -d 
